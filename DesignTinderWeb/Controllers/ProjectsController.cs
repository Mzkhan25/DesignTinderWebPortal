...
namespace DesignTinderWeb.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            return View(db.Projects.OrderByDescending(p=>p.UpVote - p.DownVote).ToList());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Region,Country,URL,UpVote,DownVote,Version,CreatedAt,UpdatedAt,Deleted")] Project project)
        {
            if (ModelState.IsValid)
            {
